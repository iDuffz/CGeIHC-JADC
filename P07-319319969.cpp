...
int main()
{
	...
	pointLights[1] = PointLight(1.0f, 1.0f, 1.0f,	//Color de la luz (blanca)
	...
	while (!mainWindow.getShouldClose())
	{
		...
		spotLights[2].SetPos(glm::vec3(-1.0f + mainWindow.getmuevex(), 5.0f, 6.0f));
