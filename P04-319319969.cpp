...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//llanta1 - articulacion
		model = modelaux;
		model = glm::translate(model, glm::vec3(2.5f, -1.0f, 1.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion5()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.5f, 1.5f, 1.5f)); //este scale no se guardará en la matriz
		...
		//llanta2 - articulacion
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-2.5f, 2.2f, -3.0f));
		...
		//llanta3 - articulacion
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-2.5f, 2.2f, -5.0f));
		...
		//articulacion1 que conecta cabina-brazo1
		model = glm::mat4(1.0);
		...
		//ya no se pone mat4 porque no queremos que la matriz se reinicie y que se elimine la jerarquia
		//Asi heredas las transformaciones anteriores
