...
// average normals
	GLfloat cubo_vertices[] = {
		...
		-0.5f,  0.5f,  0.5f,	0.25f,	0.64f,		1.0f,	0.0f,	0.0f,
...
int main()
{
	...
	dadoTexture = Texture("Textures/dado_animales_opt.png");
	dadoTexture.LoadTextureA();
	logofiTexture = Texture("Textures/escudo_fi_color.tga");
	logofiTexture.LoadTextureA();
	dado8Texture = Texture("Textures/octaedro_numeros_opt.png");
	...
	Dado_M = Model();
	Dado_M.LoadModel("Models/dado_texturizado.obj");
